<?php require("logistic_login.class.php") ?>
<?php
    if (isset($_POST['submit'])) {
        $user = new LoginLogistic($_POST['username'], $_POST['password']);
    }
?>
...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="logistic_login.css" />
    <title>Logistic Log-in</title>
  </head>
  ...
  <body>
    <div class="logistic">
      <nav class="nav nav-pills nav-fill">
        ...
        <a class="nav-link text-light" href="vendor_login.php">For Seller</a>
        <a
      ...
      <hr size="5px" />
      <div class="login">
        <p>New member? <a href="logistic_signup.php">Register here</a></p>
