...
class RegisterVendor {
    ...
    public $error;
    public $success;
    private $storage = "vendor_account.json";
    private $stored_users;
    private $new_user;

    public function __construct($username, $password, $business, $address) {
    ...
    private function checkFieldValues() {
        if (empty($this->username) || empty($this->raw_password) || empty($this->business) || empty($this->address)) {
